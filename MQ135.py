...
class MQ135():
    ...
    MQ_PIN                       = 2        # define which analog input channel you are going to use for the MQ-135 sensor (MCP3008)
    ...
    def __init__(self, Ro=10, analogPin=2):
        ...
        self.CO2Curve = [1,0.36,-0.35]    
        self.COCurve = [1,0.45,-0.26]     
        self.AlcoholCurve =[1,0.27,-0.31] 
        self.AmmoniumCurve =[1,0.41,-0.41]
        self.TolueneCurve =[1,0.19,-0.29] 
        self.AcetoneCurve =[1,0.15,-0.29] 
              
        print("Calibrating MQ-135 on pin 2...")
    ...
    def MQPercentage(self):
        ...
        val["AMMONIUM"] = self.MQGetGasPercentage(read/self.Ro, self.GAS_AMMONIUM)
        val["TOLUENE"]  = self.MQGetGasPercentage(read/self.Ro, self.GAS_TOLUENE)
        val["ACETONE"]  = self.MQGetGasPercentage(read/self.Ro, self.GAS_ACETONE)   	
    ...
    def MQGetGasPercentage(self, rs_ro_ratio, gas_id):
        ...
        elif ( gas_id == self.GAS_AMMONIUM ):
            return self.MQGetPercentage(rs_ro_ratio, self.AmmniumCurve)
        elif ( gas_id == self.GAS_TOLUENE ):
            return self.MQGetPercentage(rs_ro_ratio, self.TolueneCurve)
        elif ( gas_id == self.GAS_ACETONE ):
            return self.MQGetPercentage(rs_ro_ratio, self.AcetoneCurve)
        return 0
