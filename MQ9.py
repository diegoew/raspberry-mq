...
class MQ9():
    ...
    MQ_PIN                       = 1        # define which analog input channel you are going to use for the MQ-9 sensor (MCP3008)
    RL_VALUE                     = 18        # define the load resistance on the board, in kilo ohms
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.LPGCurve = [2.3,0.31,-0.46]     
        self.COCurve = [2.3,0.21,-0.45]     
        self.MethaneCurve =[2.3,0.48,-0.38]  
                
        print("Calibrating MQ-9 on pin 1...")
